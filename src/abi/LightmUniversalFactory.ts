...
export const events = {
    LightmCollectionCreated: new LogEvent<([collectionAddress: string, owner: string, isCustomized: boolean, customInitStruct: ([cuts: Array<([facetAddress: string, action: number, functionSelectors: Array<string>] & {facetAddress: string, action: number, functionSelectors: Array<string>})>, initAddress: string, initCallData: string] & {cuts: Array<([facetAddress: string, action: number, functionSelectors: Array<string>] & {facetAddress: string, action: number, functionSelectors: Array<string>})>, initAddress: string, initCallData: string})] & {collectionAddress: string, owner: string, isCustomized: boolean, customInitStruct: ([cuts: Array<([facetAddress: string, action: number, functionSelectors: Array<string>] & {facetAddress: string, action: number, functionSelectors: Array<string>})>, initAddress: string, initCallData: string] & {cuts: Array<([facetAddress: string, action: number, functionSelectors: Array<string>] & {facetAddress: string, action: number, functionSelectors: Array<string>})>, initAddress: string, initCallData: string})})>(
        abi, '0x5f60e7c563c0390f5eed68591bdf6a9b765791846106d51877f331efd4665ddf'
    ),
}
